...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO("MASS", 64, ParametersG2, vehicle_mass, 0),
    ...
    // @User: Advanced
    AP_GROUPINFO("ENDURE_PWR", 63, ParametersG2, nom_level_flight_power, 0),
    ...
    // @User: Advanced
    AP_GROUPINFO("ENDURE_AUX_PWR", 62, ParametersG2, auxiliary_power_consumption, 0),
    ...
    // @User: Advanced
    AP_GROUPINFO("ENDURE_ARSP", 61, ParametersG2, nom_level_flight_airspeed, 0),
    ...
    // @User: Advanced
    AP_GROUPINFO("ENDURE_MASS", 60, ParametersG2, nom_level_flight_mass, 0),
