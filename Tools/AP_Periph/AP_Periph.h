...
public:
    ...
    AP_GPS gps;
        ...
        void gps_uavcan_in_handle_fix(const uavcan_equipment_gnss_Fix &msg);
        void gps_uavcan_in_handle_fix2(const uavcan_equipment_gnss_Fix2 &msg);
        void gps_uavcan_in_handle_aux(const uavcan_equipment_gnss_Auxiliary &msg);
        void gps_uavcan_in_handle_heading(const ardupilot_gnss_Heading &msg);
        void gps_uavcan_in_handle_status(const ardupilot_gnss_Status &msg);
        bool gps_seen_fix2;
        bool gps_seen_aux;
        bool gps_seen_message;
        AP_GPS::GPS_State gps_interim_state;
    #endif
#endif
