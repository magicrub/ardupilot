...
const AP_Param::Info AP_Periph_FW::var_info[] = {
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_ipaddr, 0, "LWIP_IPADDR0", 192),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_ipaddr, 1, "LWIP_IPADDR1", 168),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_ipaddr, 2, "LWIP_IPADDR2", 1),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_ipaddr, 3, "LWIP_IPADDR3", 10),
    ...
    // @Range: 0 32
    // @User: Advanced
    GSCALAR(lwip_netmask, "LWIP_NETMASK", 24),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_gwaddr, 0, "LWIP_GWADDR0", 192),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_gwaddr, 1, "LWIP_GWADDR1", 168),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_gwaddr, 2, "LWIP_GWADDR2", 1),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_gwaddr, 3, "LWIP_GWADDR3", 1),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_macaddr, 0, "LWIP_MACADDR0", LWIP_ETHADDR_0),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_macaddr, 1, "LWIP_MACADDR1", LWIP_ETHADDR_1),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_macaddr, 2, "LWIP_MACADDR2", LWIP_ETHADDR_2),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_macaddr, 3, "LWIP_MACADDR3", LWIP_ETHADDR_3),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_macaddr, 4, "LWIP_MACADDR4", LWIP_ETHADDR_4),
    ...
    // @Range: 0 255
    // @User: Advanced
    GARRAY(lwip_macaddr, 5, "LWIP_MACADDR5", LWIP_ETHADDR_5),
