...
typedef enum
{
  ...
  GDL90_ID_OWNSHIP_REPORT             = 10,
  GDL90_ID_OWNSHIP_GEOMETRIC_ALTITUDE = 11,
  GDL90_ID_IDENTIFICATION             = 37,
  GDL90_ID_SENSOR_MESSAGE             = 40,
  GDL90_ID_TRANSPONDER_CONFIG         = 43,
  GDL90_ID_MESSAGE_REQUEST            = 44,
  GDL90_ID_TRANSPONDER_CONTROL        = 45,
  GDL90_ID_GPS_DATA                   = 46,
  GDL90_ID_TRANSPONDER_STATUS         = 47,
} GDL90_MESSAGE_ID;
