...
const AP_Param::GroupInfo AP_BattMonitor_Params::var_info[] = {
    ...
    // @Bitmask: 0:Ignore DroneCAN SoC, 1:MPPT reports input voltage and current, 2:MPPT Powered off when disarmed, 3:MPPT Powered on when armed, 4:MPPT Powered off at boot, 5:MPPT Powered on at boot, 6:Send resistance compensated voltage to GCS, 7:Enable EKF for percent remaining estimation
    // @User: Advanced
