...
#elif CONFIG_HAL_BOARD == HAL_BOARD_CHIBIOS && CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_CHIBIOS_FAP
    ADD_BACKEND(DRIVER_HMC5883, AP_Compass_HMC5843::probe(*this, GET_I2C_DEVICE(HAL_COMPASS_HMC5883_I2C_BUS, HAL_COMPASS_HMC5883_I2C_ADDR), true),
                 AP_Compass_HMC5843::name, true);
    ADD_BACKEND(DRIVER_MAG3110, AP_Compass_MAG3110::probe(*this, GET_I2C_DEVICE(HAL_COMPASS_MAG3110_I2C_BUS, HAL_COMPASS_MAG3110_I2C_ADDR), ROTATION_NONE),
                AP_Compass_MAG3110::name, true);
