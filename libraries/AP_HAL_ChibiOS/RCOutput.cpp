...
__RAMFUNC__ void RCOutput::dshot_update_tick(ch_virtual_timer *tmr, void* p)
{
    chSysLockFromISR();
 ...
 */
__RAMFUNC__ void RCOutput::dma_unlock(ch_virtual_timer *tmr, void *p)
{
    chSysLockFromISR();
...
/*
  timeout a byte read
 */
void RCOutput::serial_byte_timeout(ch_virtual_timer *tmr, void *ctx)
{
    chSysLockFromISR();
    irq.timed_out = true;
