if param:get("Q_ENABLE") == 1 then
    ...
    assert(param:get("COMPASS_PRIO1_ID") == 76035, "K1000: COMPASS_PRIO1_ID Not Correct")
    assert(param:get("COMPASS_PRIO2_ID") == 75779, "K1000: COMPASS_PRIO2_ID Not Correct")
    assert(param:get("COMPASS_PRIO3_ID") == 590114, "K1000: COMPASS_PRIO3_ID Not Correct")
