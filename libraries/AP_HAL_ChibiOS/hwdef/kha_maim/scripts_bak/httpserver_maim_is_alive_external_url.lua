...
function update() -- this is the loop which periodically runs
    ...
    while not e do
        ...
        if l:find("GET") then
            ...
            c:send("<html><body>\r\n")
            c:send("<img src=\"https://raw.githubusercontent.com/ArduPilot/ardupilot_wiki/master/images/supporters/supporters_logo_Kraus_Aerospace.png\" alt=\"ArduPilot header image\">\r\n")
            c:send("<p>The MAIM is Alive!!!!</p>\r\n")
            c:send("</body></html>\r\n")
            break
        end
        l, e = c:receive()
