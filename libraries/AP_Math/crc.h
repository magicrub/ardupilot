...
uint16_t crc_xmodem(const uint8_t *data, uint16_t len, const uint16_t seed = 0);
uint16_t crc16_ibm_update(uint16_t crc, const uint8_t data);
uint16_t crc16_ibm(const uint8_t *data, const uint16_t len, const uint16_t seed = 0);
uint16_t crc16_update(const uint16_t crc, const uint8_t data, const uint16_t poly);
