...
const AP_Param::GroupInfo AP_Mount::var_info[] = {
    ...
    // @Values: 0:None, 1:Servo, 2:3DR Solo, 3:Alexmos Serial, 4:SToRM32 MAVLink, 5:SToRM32 Serial, 6:UAV Vision
    // @RebootRequired: True
    // @User: Standard
...
void AP_Mount::init()
{
    ...
    for (uint8_t instance=0; instance<AP_MOUNT_MAX_INSTANCES; instance++) {
        ...
        // check for UAV Vision mounts
        } else if (mount_type == Mount_Type_UAVVision) {
            _backends[instance] = new AP_Mount_UAVVision(*this, state[instance], instance);
            _num_instances++;
