...
const AP_Param::GroupInfo AP_SerialManager::SerialExtState::IP_Params::var_info[] = {
    ...
    // @User: Standard
    // @RebootRequired: True
    AP_GROUPINFO("PROTOCOL",  1, AP_SerialManager::SerialExtState::IP_Params, protocol, 0),
    ...
    // @Range: 1 65535
    // @User: Standard
    AP_GROUPINFO("PORT", 2, AP_SerialManager::SerialExtState::IP_Params, port, 14550),
    ...
    // @Range: 0 255
    AP_GROUPINFO("PASSTHR", 7, AP_SerialManager::SerialExtState::IP_Params, passthru, 1),
